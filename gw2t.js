...
P = {
	 ...
	 */
	drawDirectedPath: function(pCoords, pIsClockwise)
	{
		...
		{
			layergroup.addLayer(L.polyline([latlngs[i], latlngs[i+1]], {color: "lime", weight: (iweight+2)*2}));
