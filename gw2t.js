...
P = {
	...
	drawDirectedPath: function(pCoords, pIsClockwise)
	{
		...
		{
			L.polyline([latlngs[i], latlngs[i+1]], {color: "lime", weight: (ithcolor+2)*2}).addTo(M.Map);
			ithcolor++;
			if (ithcolor >= palette.length)
			{
				ithcolor = 0;
			}
		}
